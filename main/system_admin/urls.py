...
urlpatterns = [
    ...
    path("api/login/", auth.login_api, name="login-api"),
    # 档案用户管理
    path("archive-users/", archive_users.page, name="archive-users"),
    path(
        "api/archive-users/query/", archive_users.query_api, name="archive-users-query"
    ),
    ...
    path(
        ...
        platform_users.user_list_api,
        name="platform-users-list",
    ),
    path(
        "api/platform-users/save/",
        platform_users.user_save_api,
        name="platform-users-save",
    ),
    # 认证
    ...
    path(
        "api/platform-groups/list/",
        platform_users.group_list_api,
        name="platform-groups-list",
    ),
    path(
        "api/platform-groups/save/",
        platform_users.group_save_api,
        name="platform-groups-save",
    ),
    ...
    path(
        "api/group-menus/save/",
        platform_users.group_menus_save_api,
        name="group-menus-save",
    ),
]
